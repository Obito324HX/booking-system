...
export const api = {
  ...
  createBookingCheckout: (slug, payload) =>
    request(`/businesses/${slug}/bookings/checkout`, { method: 'POST', body: JSON.stringify(payload) }),
  getBookingPublic: (bookingId) => request(`/bookings/${bookingId}/public`),
  demoPay: (bookingId) => request(`/bookings/${bookingId}/demo-pay`, { method: 'POST' }),
